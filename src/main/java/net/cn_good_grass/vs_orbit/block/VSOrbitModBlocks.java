...
public class VSOrbitModBlocks {
    ...
    public static final RegistryObject<Block> electrical_truster = BLOCKS.register("electrical_truster", ElectricalTrusterBlock::new);
    public static final RegistryObject<Block> celestial_tachymeter = BLOCKS.register("celestial_tachymeter", CelestialTachymeterBlock::new);
    // 在构造函数中注册到主模组总线

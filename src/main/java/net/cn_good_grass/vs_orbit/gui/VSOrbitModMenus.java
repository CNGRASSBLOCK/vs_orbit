...
public class VSOrbitModMenus {
	...
	public static final RegistryObject<MenuType<JumpEngineControllerGUIMenu>> JumpEngineControllerGUI = REGISTRY.register("bbbb", () -> IForgeMenuType.create(JumpEngineControllerGUIMenu::new));
}

...
public class CameraAstronomical extends Astronomical {
    public CameraAstronomical(int id, String name, boolean compute, double mass, double x, double y, double z) {
    ...
    private static CameraAstronomical FromJsonObject(JsonObject jsonObject) {
        ...
        CameraAstronomical astronomical = new CameraAstronomical(id, name, compute, mass, x, y, z);

...
public class ParticleUpdate {
    ...
    public static void SpeedUpdates(GravitationWorld World) {
        ...
        for (Particle particle : World.Gravitation_Core_World) {
            ...
            particle.x_speed += GlobalVariables.core_tick_time * Gravitation.x; //更新速度
            particle.y_speed += GlobalVariables.core_tick_time * Gravitation.y;
            particle.z_speed += GlobalVariables.core_tick_time * Gravitation.z;
        }
    }
    ...
    public static void LocationUpdates(GravitationWorld World) {
        ...
        for (Particle particle : World.Gravitation_Core_World) {
            ...
            particle.x += GlobalVariables.core_tick_time * Speed.x; //更新位置
            particle.y += GlobalVariables.core_tick_time * Speed.y;
            particle.z += GlobalVariables.core_tick_time * Speed.z;
        }
    }
}

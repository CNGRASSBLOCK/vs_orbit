...
public class ParticleGravitation {
    ...
    public static Vector3d GetParticleGravitationForOneParticle(Particle this_particle, Particle other_particle) {
        ...
        double this_particle_mass = this_particle.mass;
        ...
        double F = G * ((this_particle_mass * other_particle.mass) / Math.pow(world_distance, 2)); //万有引力公式 F=G*(m物*m星/r距²)
        ...
        double X_acceleration = X_F / this_particle_mass; //在世界参考系中X轴上的加速度
        double Y_acceleration = Y_F / this_particle_mass; //在世界参考系中Y轴上的加速度
        double Z_acceleration = Z_F / this_particle_mass; //在世界参考系中Z轴上的加速度

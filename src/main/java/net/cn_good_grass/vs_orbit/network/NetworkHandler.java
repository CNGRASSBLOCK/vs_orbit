...
public class NetworkHandler {
    ...
    public static void register() {
        ...
        INSTANCE.registerMessage(12, SyncElectricalTrusterGUI.class, SyncElectricalTrusterGUI::encode, SyncElectricalTrusterGUI::decode, SyncElectricalTrusterGUI::handle);
    }
}

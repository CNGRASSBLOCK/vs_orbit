...
public class VSOrbitModClientConfigInit {
    @SubscribeEvent
    public static void register(FMLConstructModEvent event) {
        event.enqueueWork(() -> {
            ModLoadingContext.get().registerConfig(ModConfig.Type.CLIENT, VSOrbitModClientConfig.SPEC, "vs_orbit_client_config.toml");
        });
    }
}

...
public class VSOrbitModConfigInit {
    @SubscribeEvent
    public static void register(FMLConstructModEvent event) {
        event.enqueueWork(() -> ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, VSOrbitModConfig.SPEC, "vs_orbit_config.toml"));
    }
}
